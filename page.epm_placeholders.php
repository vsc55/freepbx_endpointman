...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function copyToClipboard(text) {
		...
		fpbxToast("Copy To Clipboard", '', 'success');
    }
});
...
<div class="container-fluid">
    ...
    <div class="fpbx-container">
        <div class="alert alert-info alert-dismissible fade show" role="alert">
            ...
            This page helps you building your phone Packages.<br>
            <br>
            Create or modify your config files and replace the needed values with the Placeholders. <br />
            With this information you can add new Phones to OSS EPM within minutes. <br />
            <br />
